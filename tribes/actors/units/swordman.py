"Swordman unit, ported from Swordman.java."
...
class Swordman(Unit):
    def __init__(self, pos: Vector2d, kills: int, is_veteran: bool,
        ...
        super().__init__(
            cfg.SWORDMAN_ATTACK, cfg.SWORDMAN_DEFENCE, cfg.SWORDMAN_MOVEMENT,
            cfg.SWORDMAN_MAX_HP, cfg.SWORDMAN_RANGE, cfg.SWORDMAN_COST,
            pos, kills, is_veteran, city_id, tribe_id,
        )

    def get_type(self) -> UNIT_TYPE:
        return UNIT_TYPE.SWORDMAN

    def copy(self, hide_info: bool = False) -> Swordman:
        c = Swordman(self.position, self.get_kills(), self.is_veteran(),
