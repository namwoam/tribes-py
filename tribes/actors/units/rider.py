"Rider unit, ported from Rider.java."
...
class Rider(Unit):
    def __init__(self, pos: Vector2d, kills: int, is_veteran: bool,
        ...
        super().__init__(
            cfg.RIDER_ATTACK, cfg.RIDER_DEFENCE, cfg.RIDER_MOVEMENT,
            cfg.RIDER_MAX_HP, cfg.RIDER_RANGE, cfg.RIDER_COST,
            pos, kills, is_veteran, city_id, tribe_id,
        )

    def get_type(self) -> UNIT_TYPE:
        return UNIT_TYPE.RIDER

    def copy(self, hide_info: bool = False) -> Rider:
        c = Rider(self.position, self.get_kills(), self.is_veteran(),
