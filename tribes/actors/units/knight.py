"Knight unit, ported from Knight.java."
...
class Knight(Unit):
    def __init__(self, pos: Vector2d, kills: int, is_veteran: bool,
        ...
        super().__init__(
            cfg.KNIGHT_ATTACK, cfg.KNIGHT_DEFENCE, cfg.KNIGHT_MOVEMENT,
            cfg.KNIGHT_MAX_HP, cfg.KNIGHT_RANGE, cfg.KNIGHT_COST,
    ...
    def copy(self, hide_info: bool = False) -> Knight:
        c = Knight(self.position, self.get_kills(), self.is_veteran(),
