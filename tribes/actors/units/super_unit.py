"SuperUnit unit, ported from SuperUnit.java."
...
class SuperUnit(Unit):
    def __init__(self, pos: Vector2d, kills: int, is_veteran: bool,
        ...
        super().__init__(
            cfg.SUPERUNIT_ATTACK, cfg.SUPERUNIT_DEFENCE, cfg.SUPERUNIT_MOVEMENT,
            cfg.SUPERUNIT_MAX_HP, cfg.SUPERUNIT_RANGE, cfg.SUPERUNIT_COST,
            pos, kills, is_veteran, city_id, tribe_id,
        )

    def get_type(self) -> UNIT_TYPE:
        return UNIT_TYPE.SUPERUNIT

    def copy(self, hide_info: bool = False) -> SuperUnit:
        c = SuperUnit(self.position, self.get_kills(), self.is_veteran(),
